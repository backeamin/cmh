                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#user-modal"><i class="fe-plus"></i> New User</button>
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-horizontal" action="{{route('user.update', $user->id)}}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group account-btn text-center">
                                                            <button class="btn width-lg btn-rounded btn-primary waves-effect waves-light" type="submit">Update User</button>
                                                        </div>
                                ...
                                <form class="form-horizontal" action="{{route('user.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="role_id" id="role_id">
                                            <Option selected value="3">Personal</Option>
                                    ...
                                    <div class="form-group account-btn text-center">
                                        <div class="row">
                                            <div class="col-6 text-right">
                                                <button class="btn width-lg btn-rounded btn-primary waves-effect waves-light" type="submit">Create user</button>
                                            </div>
                                            <div class="col-6 text-left">
                                                <a class="btn btn-primary btn-rounded" href="{{route('user.index')}}">Back To User list</a>
                                            </div>
                                        </div>
                                    </div>
